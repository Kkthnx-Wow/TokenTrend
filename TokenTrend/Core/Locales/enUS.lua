...
-- Import (seed history from the website)
L["Import"] = "Import"
L["Import History"] = "Import History"
L["Get URL"] = "Get URL"
L["Copy this address, then open it in your web browser:"] = "Copy this address, then open it in your web browser:"
L["Seed page: %s"] = "Seed page: %s"
L["Paste a seed string from kkthnx.com/wow/token to fill your chart."] = "Paste a seed string from kkthnx.com/wow/token to fill your chart."
L["Paste seed string here"] = "Paste seed string here"
L["Import"] = "Import"
L["Imported %d of %d samples."] = "Imported %d of %d samples."
L["Nothing new to import - your history already covers it."] = "Nothing new to import - your history already covers it."
L["Nothing to import."] = "Nothing to import."
L["That doesn't look like a valid seed string."] = "That doesn't look like a valid seed string."
L["This seed is from a different version. Grab a fresh one."] = "This seed is from a different version. Grab a fresh one."
L["That seed is for %s, but you're on %s."] = "That seed is for %s, but you're on %s."
L["That seed has no data in it."] = "That seed has no data in it."
L["Seed the chart with history from kkthnx.com/wow/token."] = "Seed the chart with history from kkthnx.com/wow/token."
...
L["/tt import - paste history from the website"] = "/tt import - paste history from the website"
L["/tt url - show the seed page address to copy"] = "/tt url - show the seed page address to copy"
